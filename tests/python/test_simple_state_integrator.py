...
assertApprox(integrator.state.value, np.array([dt, 0., 0.] + [0.] * 6))

t += 1
integrator.control.value = np.array([0., 1., 0.] + [0.] * 6)
integrator.state.recompute(t)
assertApprox(integrator.state.value, np.array([dt, dt, 0.] + [0.] * 6))

t += 1
integrator.control.value = np.array([0., 0., 1.] + [0.] * 6)
integrator.state.recompute(t)
assertApprox(integrator.state.value, np.array([dt, dt, dt] + [0.] * 6))

t += 1
integrator.control.value = np.array([0.] * 3 + [1., 0., 0.] + [0.] * 3)
integrator.state.recompute(t)
assertApprox(integrator.state.value, np.array([dt] * 3 + [dt, 0., 0.] + [0.] * 3))

t += 1
integrator.setState(initstate)
integrator.control.value = np.array([0.] * 3 + [0., 1., 0.] + [0.] * 3)
integrator.state.recompute(t)
assertApprox(integrator.state.value, np.array([0.] * 3 + [0., dt, 0.] + [0.] * 3))

t += 1
integrator.setState(initstate)
integrator.control.value = np.array([0.] * 3 + [0., 0., 1.] + [0.] * 3)
integrator.state.recompute(t)
assertApprox(integrator.state.value, np.array([0.] * 3 + [0., 0., dt] + [0.] * 3))

t += 1
integrator.setState(initstate)
integrator.control.value = np.array([0.] * 6 + [1., 0., 0.])
integrator.state.recompute(t)
assertApprox(integrator.state.value, np.array([0.] * 6 + [dt, 0., 0.]))
...
for k in range(N):
    ...
    integrator.control.value = np.array([0.] * 3 + [1., 0., 0.] + [0.] * 3)
    integrator.state.recompute(t)
    assertApprox(integrator.state.value, np.array([0.] * 3 + [dt * (k + 1), 0., 0.] + [0.] * 3))
